...
// NOTE
/*
If you want to iterate any class using getElementsByClassName() you have to use for loop in order to iterate the content
*/
const first2 = document.getElementsByClassName("first");
console.log("Iterating innerText using for loop")
