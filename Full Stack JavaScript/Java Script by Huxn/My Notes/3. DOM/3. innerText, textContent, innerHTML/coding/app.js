/*
❌ Problem:
A <ul> is not allowed inside a <table> directly.
A <table> is also not valid inside a <p> tag.
So, the browser automatically restructures the DOM, often removing or relocating the invalid tags.
As a result, the <li> elements may no longer be children of the <p> tag when the browser renders the page and builds the DOM.
*/
// innerText
