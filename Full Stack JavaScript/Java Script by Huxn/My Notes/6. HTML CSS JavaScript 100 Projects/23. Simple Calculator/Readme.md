...
> A clean, functional calculator built using basic DOM logic.       
...
🔗 Watch here: [Video](./demo/Project%2023.mov)     
<video src="./demo/Project 23.mov" controls width="800"></video>
...
- Writing clean arithmetic logic
- Improving JS function structure
