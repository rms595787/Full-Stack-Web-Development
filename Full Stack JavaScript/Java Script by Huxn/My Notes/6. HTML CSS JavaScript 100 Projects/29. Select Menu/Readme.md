...
> A custom dropdown menu with clean UI interactions.        
...
🔗 Watch here: [Video](./demo/Project%2029.mov)     
<video src="./demo/Project 29.mov" controls width="800"></video>
...
- Creating custom dropdown interactions
- Improving UX with clear visual states
- Handling option selection smoothly
