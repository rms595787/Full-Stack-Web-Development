...
> A clean and smooth popup form with overlay effects.       
...
🔗 Watch here: [Video](./demo/Project%2026.mov)     
<video src="./demo/Project 26.mov" controls width="800"></video>
...
- Toggling modals with JS
- Using overlays for UI depth
- Managing open/close form states smoothly
